...
<html lang="eng">
<head>
<link href="<?=base_url('public');?>/assets/css/loader.css" rel="stylesheet">
...
<script src="<?=base_url('public');?>/assets/js/jquery.js"></script>
 <script src="<?=base_url('public');?>/assets/js/jquery-bgstretcher-3.0.1.min.js"></script>
<script type="text/javascript">
        jQuery(function($){
            $("body").bgStretcher({
                images: ["<?=base_url('uploads/banner1.jpg')?>","<?=base_url('uploads/banner2.jpg')?>"],
                imageWidth: 1366,
                imageHeight: 768,
                slideDirection: 'N',
                slideShowSpeed: 3000,
...
<div id="wrapper">
      ...
      <div id="login-container">
          <div id="brand-container">
              ...
              <img src="<?=base_url('public/assets/images/brand-logo.png')?>" style="margin-top: 95px;"/>
