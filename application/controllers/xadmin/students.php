...
class students extends crackerjack{
	...
	public function index($id = false){
		...
		$data['students'] = $this->crud->read('SELECT * FROM _student INNER JOIN _section ON _student.section_id = _section.section_id INNER JOIN _course ON _student.course_id = _course.course_id WHERE _student.status=1 ORDER BY _student.last_name',array(),'obj');
		...
		$this->load->template('xadmin/students',26,$data);
	}
